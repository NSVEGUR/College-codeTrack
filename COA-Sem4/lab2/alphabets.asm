; Given a string, write ALP for counting 
; number of words, characters (including spaces), 
; vowels, consonants, and display the result as the output. 
; (For eg: given ‘Hello IIITDM Kancheepuram’, then program should 
; display number of words = 3, characters = 25, vowels = 10, consonants = 13)
...
section .data
    ...
    string db "Hello IIITDMKancheepuram"
    len equ $-string
